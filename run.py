...
def get_sales_data():
    ...
    via the terminal, which will repeat requesting data until it is valid.
    """
    while True:
...
def validate_data(values):
    """
    Insisde the try, converts all strings values into integers.
...
"""
REFACTORED THE TWO FOLLOWING FUCNTION INTO update_worksheet(data, worksheet) for better practice
def update_sales_worksheet(data):
    ...
    print("Sales worksheet update successful.\n")
